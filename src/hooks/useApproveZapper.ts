...
import {MATIC_TICKER, GEM_TICKER, GSHARE_TICKER, ETH_TICKER, ZAPPER_ROUTER_ADDR} from '../utils/constants';
...
function useApproveZapper(zappingToken: string): [ApprovalState, () => Promise<void>] {
  ...
  else if (zappingToken === ETH_TICKER) token = gemFinance.externalTokens[ETH_TICKER];
