      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{textAlign: 'right', height: '20px'}}>
            <a
              href="https://twitter.com/GemstoneFIn"
            ...
            <a href="https://github.com/gemstonefinance" rel="noopener noreferrer" target="_blank" className={classes.link}>
              <IconGithub style={{fill: '#dddfee', height: '20px'}} />
            </a>
            <a href="https://t.me/gemstonfin" rel="noopener noreferrer" target="_blank" className={classes.link}>
              <IconTelegram style={{fill: '#dddfee', height: '20px'}} />
            </a>
            <a href="https://discord.com/invite/5Zuc7785hj" rel="noopener noreferrer" target="_blank" className={classes.link}>
