...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(gemFinance.GSHARE, gemFinance.contracts.Boardroom.address);

  const tokenBalance = useTokenBalance(gemFinance.GSHARE);
  const stakedBalance = useStakedBalanceOnBoardroom();
  const {from, to} = useUnstakeTimerBoardroom();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('GSHARE', gemFinance.GSHARE);
