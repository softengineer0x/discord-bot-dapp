...
import {Bank as BankEntity} from '../../gem-finance';
...
const LPTokenHelpText: React.FC<{bank: BankEntity}> = ({bank}) => {
  ...
  const gemAddr = gemFinance.GEM.address;
  const bshareAddr = gemFinance.GSHARE.address;

  let pairName: string;
  let uniswapUrl: string;
  if (bank.depositTokenName.includes('GEM')) {
    pairName = 'GEM-ETH pair';
    uniswapUrl = 'https://quickswap.exchange/#/add/0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619/' + gemAddr;
  } else {
    pairName = 'GSHARE-MATIC pair';
    uniswapUrl = 'https://quickswap.exchange/#/add/MATIC/' + bshareAddr;
  }
  return (
    <Card>
      <CardContent>
